...
[Download latest release](https://github.com/nowJDev/codex-session-manager/releases/tag/v0.5.4) · [Report an issue](https://github.com/nowJDev/codex-session-manager/issues/new)
...
`v0.5.0` was kept as the first port tag for history, but its release workflow was superseded by `v0.5.1` after updating GitHub Actions to Node 24 for `pnpm 11.8.0`. Use `v0.5.4` or newer for the new icon, summary retry fix, installer auto-update, and portable Windows asset.
...
The current release is [Codex Session Manager v0.5.4](https://github.com/nowJDev/codex-session-manager/releases/tag/v0.5.4).

| Platform | Asset |
|---|---|
| Windows | `Codex.Session.Manager_0.5.4_x64-setup.exe`, `Codex.Session.Manager_0.5.4_x64_en-US.msi`, or `Codex.Session.Manager_v0.5.4_x64-portable.zip` |
| macOS Apple Silicon | `Codex.Session.Manager_0.5.4_aarch64.dmg` |
